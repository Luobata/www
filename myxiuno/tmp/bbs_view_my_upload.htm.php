...
<ul class="left_menu">
	...
	<div class="right">
		<div class="page tab" style="margin-bottom: 4px;">
						<a href="http://localhost/myxiuno/?my-upload.htm" <?php echo isset($_checked['upload']) ? $_checked['upload'] : '';?>>上传文件</a>
			<a href="http://localhost/myxiuno/?my-image.htm" <?php echo isset($_checked['image']) ? $_checked['image'] : '';?>>上传图片</a>
			<a href="http://localhost/myxiuno/?my-download.htm" <?php echo isset($_checked['download']) ? $_checked['download'] : '';?>>下载附件</a>
		...
		<div class="list">
			<table class="table">
				...
				<tr>
					...
					<td><a href="http://localhost/myxiuno/?forum-index-fid-<?php echo isset($attach['fid']) ? $attach['fid'] : '';?>.htm" target="_blank"><?php echo isset($attach['forumname']) ? $attach['forumname'] : '';?></a></td>
					<td><a href="http://localhost/myxiuno/?my-attachthread-fid-<?php echo isset($attach['fid']) ? $attach['fid'] : '';?>-pid-<?php echo isset($attach['pid']) ? $attach['pid'] : '';?>.htm" target="_blank">点击查看</a></td>
					<td><a href="http://localhost/myxiuno/?my-downlog-fid-<?php echo isset($attach['fid']) ? $attach['fid'] : '';?>-aid-<?php echo isset($attach['aid']) ? $attach['aid'] : '';?>.htm">查看下载历史</a></td>
				</tr>
				<?php }} ?>
				<?php } else { ?>
				<tr>
