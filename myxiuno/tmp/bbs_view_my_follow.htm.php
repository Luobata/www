...
<ul class="left_menu">
	...
	<div class="right">
		...
		<div class="page tab" style="margin-bottom: 4px;">
			<a href="http://localhost/myxiuno/?my-follow.htm" <?php echo isset($_checked['follow']) ? $_checked['follow'] : '';?>>我的关注</a>
			<a href="http://localhost/myxiuno/?my-followed.htm" <?php echo isset($_checked['followed']) ? $_checked['followed'] : '';?>>我的粉丝</a>
			<a href="http://localhost/myxiuno/?my-pm.htm" <?php echo isset($_checked['pm']) ? $_checked['pm'] : '';?>>最近联系人</a>
			...
			<?php if(!empty($userlist)) { foreach($userlist as &$user) {?>
				<li>
					<div>
						...
						<a href="http://localhost/myxiuno/?pm-ajaxlist-uid-<?php echo isset($user['uid']) ? $user['uid'] : '';?>-ajax-1.htm" class="ajaxdialog" ajaxdialog="{position: 'center', modal: false}" value="短消息" onclick="return false;" /><span class="avatar_middle border" style="<?php if($user['avatar_middle']) { ?>background-image: url(<?php echo isset($user['avatar_middle']) ? $user['avatar_middle'] : '';?>)<?php } ?>" uid="<?php echo isset($user['uid']) ? $user['uid'] : '';?>"></span></a>
						<?php } else { ?>
					...
					<div style="white-space: nowrap;">
						<a href="http://localhost/myxiuno/?you-index-uid-<?php echo isset($user['uid']) ? $user['uid'] : '';?>.htm" target="_blank" rel="nofollow"><span style="font-size: 12px; white-space: nowrap;" title="<?php echo isset($user['username']) ? $user['username'] : '';?>"><?php echo isset($user['username']) ? $user['username'] : '';?></span></a>
					</div>
