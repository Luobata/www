...
class thread_control extends admin_control {
	...
	public function on_replace() {
		...
		$this->message('替换完毕', 1, "http://localhost/myxiuno/admin/?thread-list-uid-$uid-tidfrom-$tidfrom-tidto-$tidto-srchstring-$srchstring_url-replacestring-$replacestring_url.htm");
	}
	...
	public function on_delete() {
		...
		$this->message('删除完毕', 1, "http://localhost/myxiuno/admin/?thread-list-uid-$uid-tidfrom-$tidfrom-tidto-$tidto.htm");
	}
