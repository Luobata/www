...
class my_control extends common_control {
	...
	public function on_post() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-post.htm", count($mypostlist), $page, $pagesize);
	...
	public function on_follow() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-follow.htm", count($followlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_followed() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-followed.htm", count($followedlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_income() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-income.htm", count($incomelist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_download() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-download.htm", count($downlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_upload() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-upload.htm", count($attachlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
	...
	public function on_image() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-image.htm", count($attachlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
		$this->view->assign('attachlist', $attachlist);
	...
	public function on_attachthread() {
		...
		$this->location("http://localhost/myxiuno/?thread-index-fid-$fid-tid-$post[tid].htm");
	}
	...
	public function on_downlog() {
		...
		$pages = misc::simple_pages("http://localhost/myxiuno/?my-downlog-fid-$fid-aid-$aid.htm", count($downlist), $page, $pagesize);
		$this->view->assign('pages', $pages);
		$this->view->assign('downlist', $downlist);
