	...
	<div class="div">
		...
		<div class="body">
			...
			<div style="margin-top: 4px; line-height: 2;">
				<span class="grey"><a href="http://localhost/myxiuno/?forum-index-fid-<?php echo isset($post['fid']) ? $post['fid'] : '';?>.htm" target="_blank">【<?php echo isset($post['forumname']) ? $post['forumname'] : '';?>】</a></span><a href="http://localhost/myxiuno/?thread-index-fid-<?php echo isset($post['fid']) ? $post['fid'] : '';?>-tid-<?php echo isset($post['tid']) ? $post['tid'] : '';?>-page-<?php echo isset($post['post']['page']) ? $post['post']['page'] : '';?>.htm" target="_blank"><?php echo isset($post['thread']['subject']) ? $post['thread']['subject'] : '';?></a>
