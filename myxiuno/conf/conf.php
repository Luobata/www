...
return array(
	...
	'app_url' => 'http://localhost/myxiuno/',
	
	// CDN 缓存的静态域名，如 http://static.domain.com/
	'static_url' => 'http://localhost/myxiuno/',
	...
	'upload_url' => 'http://localhost/myxiuno/upload/',
	
	'logo_url' => 'http://localhost/myxiuno/',
	...
	// 插件目录对应的URL
	'plugin_url' => 'http://localhost/myxiuno/plugin/',
	...
	// 点击服务器
	'click_server' => 'http://localhost/myxiuno/service/clickd/',	// 记录主题点击数，论坛点击数
	
	// 加密KEY，
	'auth_key' => '37921acd93606b41ee163ed0b64eef84',
	
	// 站点的ID，用来和官方通信，下载，安装插件。
	'siteid' => '879b80a1245a5428c8ea98a597c579f1',
