...
var get_transform_value = function(e, t) {
	...
	INDEX = function() {
		...
		d[1] = v("_desc"), d[2] = v("_desc2"), d[3] = v("_desc3"), d[4] = v("_desc4"), d[5] = v("_desc5"), d[6] = v("_desc6"), d[7] = v("_desc7"), d[8] = v("6"), d[9] = v("7"), d[10] = v("8");
		...
		var x = $("#loading"),
			T = $("#loading_text"),
			N = function() {
				var e = [ "images/1.jpg", "images/2.jpg", "images/3.jpg", "images/4.jpg", "images/5.jpg", "images/6.jpg", "images/7.jpg", "images/8.jpg", "images/iphone.png","images/xz.png","images/qb.png","images/submit.png","images/qb.png"],
					t = e.length,
					n = 0,
					r = function(e) {
						var r = new Image;
